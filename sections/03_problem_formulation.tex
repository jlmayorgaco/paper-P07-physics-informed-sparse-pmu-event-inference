...
Table~\ref{tab:physical-operators} states how the four physical families enter the candidate DAE. It is an operator contract, not a claim that the proposed posterior has already solved every family.
