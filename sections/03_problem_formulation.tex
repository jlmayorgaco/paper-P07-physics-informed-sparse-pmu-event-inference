...
Supplementary Appendix~B defines this candidate-conditioned virtual electrical
output map, including the qualifications for model-implied frequency, ROCOF,
and balanced waveform synthesis. These derived quantities are not additional
independently estimated states, and only hidden complex voltage is empirically
validated in the present state-reconstruction campaigns.
