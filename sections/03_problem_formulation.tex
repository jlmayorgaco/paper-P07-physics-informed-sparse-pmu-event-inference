...
\end{equation}
The orientation, transformer tap, line charging, and shunt convention in \eqref{eq:terminal-current} are part of the measurement model; replacing terminal current with bus-injection current changes the likelihood.
