...
The statistical object in the complete formulation is the
candidate-conditioned joint posterior and normalized evidence, with state and
integrity nuisance modeled under each physical hypothesis. Iterated smoothing,
...
For each candidate, virtual electrical outputs are deterministic functionals of
