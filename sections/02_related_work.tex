...
\caption{Selected development of state/input estimation, event-source inference, and observability-based sensor analysis. The rows separate methods that are often conflated: reconstructing latent variables \cite{gillijns2007input,nugroho2022dae,qu2023joint}, assigning an event or source \cite{tate2008outage,zhao2014outages,chen2016quickest,pandey2020realtime}, and determining whether the requested quantity is identifiable from the sensors \cite{hou1998input,eriksson2013diagnosability,pasqualetti2013attack,jamei2020limits}. The lower bracket marks the combined contract that remains untested.}
