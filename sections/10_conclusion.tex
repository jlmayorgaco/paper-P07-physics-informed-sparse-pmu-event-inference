...
The present evidence supports matched-model state reconstruction and simultaneous load-source inference as separate components. The new single-event pilot specifies a numerical route toward joint inference but records a final-selection failure that must be resolved. A common multi-family experiment with state and integrity nuisance, source holdout, changing sensing, and physical shift is still required before a joint operational decision can be trusted.
