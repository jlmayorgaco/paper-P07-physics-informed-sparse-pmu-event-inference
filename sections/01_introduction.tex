...
\caption{Scientific argument and validation boundary. The blue B0--B3 path is an independently evaluated state-reconstruction component. The green path is the implemented batch reference estimator $\mathcal E_{\mathrm B}$. The dashed path is the proposed joint estimator $\mathcal E_{\mathrm J}$; it remains outside the present evidence.}
